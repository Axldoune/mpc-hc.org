...
<div class="row hidden-xs">
    <div class="col-sm-4 col-md-4">
        <a class="fancybox-thumb" data-fancybox-group="gallery" href="/img/mpc-hc.original.jpg" title="MPC-HC's main window">
            <img src="/img/mpc-hc.original.thumb.jpg" alt="MPC-HC" width="180" height="134"/>
        </a>
    </div>
    <div class="col-sm-4 col-md-4">
        <a class="fancybox-thumb" data-fancybox-group="gallery" href="/img/mpc-hc.toolbar.jpg" title="MPC-HC with custom toolbar" data-title-id="title-toolbar">
            <img src="/img/mpc-hc.toolbar.thumb.jpg" alt="MPC-HC with custom toolbar" width="180" height="134"/>
        </a>
    ...
    <div class="col-sm-4 col-md-4">
        <a class="fancybox-thumb" data-fancybox-group="gallery" href="/img/mpc-hc.dvb.jpg" title="MPC-HC as DVB Player">
            <img src="/img/mpc-hc.dvb.thumb.jpg" alt="MPC-HC as DVB Player" width="182" height="137"/>
        </a>
    </div>
</div>
